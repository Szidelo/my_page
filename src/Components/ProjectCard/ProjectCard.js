...
const ProjectCard = ({ data }) => {
	...
	return (
		<div className="project-card row py-5">
			...
			<div className="col-12 col-xl-6 col-xxl-8">
				<div className="project-card__info col-12 col-xl-8 d-flex flex-column align-items-end justify-content-evenly position-relative pt-5">
					...
					<p className="body text-end">{data.desc}</p>
					<a
						href={data.source}
